var Persistence = require('pwdb/lib/persistence'),
  model = require('pwdb/lib/model'),
  customUtils = require('pwdb/lib/customUtils'),
...
function Logger(dbOptions) {
  ...
  if (!fs.existsSync(dbOptions.filename)) {
    fs.writeFileSync(dbOptions.filename, '', 'utf8');
  }
}
